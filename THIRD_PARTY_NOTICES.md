...
TeleStream is distributed under GPL-3.0. It also contains or depends on the components below. Their
...
Each TeleStream release includes a `nextlib-corresponding-source-<version>.tar.gz` archive containing
...
under permissive licences and do not impose a corresponding-source requirement on TeleStream.
...
- The player mark was adapted and recoloured from an SVG Repo player icon. SVG Repo is credited in
  the website footer and README; the adapted vector is distributed with TeleStream under GPL-3.0.

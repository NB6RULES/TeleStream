...
export const ChatSidebar: React.FC<ChatSidebarProps> = ({
  ...
  return (
    <aside className={`md:w-72 lg:w-80 flex-shrink-0 bg-slate-900/60 border-r border-slate-800/80 flex flex-col h-[calc(100vh-65px)] ${selectedChatId ? 'hidden md:flex' : 'w-full flex'}`}>
